...
namespace Wiki.Sample.NonPersistenObjects.Module.Controllers
{
    ...
    public partial class ModalDialogController : ViewController
    {
        ...
        {
            var objectSpace = Application.CreateObjectSpace(typeof(DialogObject));

            var newObject = objectSpace.CreateObject<DialogObject>();
